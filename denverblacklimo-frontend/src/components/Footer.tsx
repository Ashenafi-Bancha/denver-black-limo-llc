...
import { FACEBOOK_URL, PHONE, PHONE_HREF, EMAIL, EMAIL_HREF, ADDRESS } from '../constants'
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            <li className="flex items-center gap-3">
              ...
              <a href={PHONE_HREF} className="transition hover:text-brand-gold-light">
                {PHONE}
              </a>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a href={EMAIL_HREF} className="transition hover:text-brand-gold-light">
                {EMAIL}
              </a>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a href={FACEBOOK_URL} className="transition hover:text-brand-gold-light">
                Facebook
              </a>
            </li>
            <li className="flex items-center gap-3">
